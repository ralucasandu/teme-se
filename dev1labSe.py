...
import sys, threading, logging, os, os.path
        ...
        with open(working_dir + argv[1], 'r') as f:
            ...
            for ligne in f:
                ...
                if ligne[0:2] == "M.":
                    ...
                    m_local = Bonjour("Monsieur"+ligne.strip(' \r\n').split(".")[1])
                    ...
                    #print "merge pana aici"

                    mle_local = Bonjour("Mademoiselle"+ligne.strip(' \r\n').split(".")[1])

                    mleThread.append(mle_local)

                    mle_local.start()

                else:

                    mme_local = Bonjour("Madame"+ligne.strip(' \r\n').split(".")[1])
